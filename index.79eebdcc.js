 ...
 * limitations under the License.
 */
var r,a;n.setAttribute("src",e),n.onload=t,n.onerror=e=>{const t=It("internal-error");t.customData=e,i(t)},n.type="text/javascript",n.charset="UTF-8",(null!==(a=null===(r=document.getElementsByTagName("head"))||void 0===r?void 0:r[0])&&void 0!==a?a:document).appendChild(n)}))}function yn(e){return`__${e}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vn.PROVIDER_ID="phone",vn.PHONE_SIGN_IN_METHOD="phone";class wn extends Ti{_getIdTokenResponse(e){return Li(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Li(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Li(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}constructor(e){super("custom","custom"),this.params=e}}function kn(e){return Ki(e.auth,new wn(e),e.bypassAuthState)}function In(e){const{auth:t,user:i}=e;return Tt(i,t,"internal-error"),Xi(i,new wn(e),e.bypassAuthState)}async function _n(e){const{auth:t,user:i}=e;return Tt(i,t,"internal-error"),Gi(i,new wn(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jn=new Pt(3e4,6e4);function Hn(){const e=sn().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Vn=null;function qn(e){return Vn=Vn||function(e){return new Promise(((t,i)=>{var n,r,a;function o(){Hn(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Hn(),i(It(e,"network-request-failed"))},timeout:jn.get()})}if(null===(r=null===(n=sn().gapi)||void 0===n?void 0:n.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(a=sn().gapi)||void 0===a?void 0:a.load)){const t=yn("iframefcb");return sn()[t]=()=>{gapi.load?o():i(It(e,"network-request-failed"))},gn(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>i(e)))}o()}})).catch((e=>{throw Vn=null,e}))}(e),Vn}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
