 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var mt;mt="",Ye(new ye("platform-logger",(e=>new qe(e)),"PRIVATE")),Ye(new ye("heartbeat",(e=>new lt(e)),"PRIVATE")),nt("@firebase/app","0.8.3",mt),nt("@firebase/app","0.8.3","esm2017"),nt("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function li(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(mi(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(ci(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(fi(t))return"Blackberry";if(pi(t))return"Webos";if(di(t))return"Safari";if((t.includes("chrome/")||ui(t))&&!t.includes("edge/"))return"Chrome";if(hi(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=e.match(t);if(2===(null==i?void 0:i.length))return i[1]}return"Other"}function ci(e=J()){return/firefox\//i.test(e)}function di(e=J()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function ui(e=J()){return/crios\//i.test(e)}function mi(e=J()){return/iemobile/i.test(e)}function hi(e=J()){return/android/i.test(e)}function fi(e=J()){return/blackberry/i.test(e)}function pi(e=J()){return/webos/i.test(e)}function gi(e=J()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function yi(){return Q()&&10===document.documentMode}function bi(e=J()){return gi(e)||hi(e)||pi(e)||fi(e)||/windows phone/i.test(e)||mi(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Di{static parseLink(e){const t=function(e){const t=ue(me(e)).link,i=t?ue(me(t)).deep_link_id:null,n=ue(me(e)).deep_link_id;return(n?ue(me(n)).link:null)||n||i||t||e}(e);try{return new Di(t)}catch(e){return null}}constructor(e){var t,i,n,r,a,o;const s=ue(me(e)),l=null!==(t=s.apiKey)&&void 0!==t?t:null,c=null!==(i=s.oobCode)&&void 0!==i?i:null,d=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(n=s.mode)&&void 0!==n?n:null);Tt(l&&c&&d,"argument-error"),this.apiKey=l,this.operation=d,this.code=c,this.continueUrl=null!==(r=s.continueUrl)&&void 0!==r?r:null,this.languageCode=null!==(a=s.languageCode)&&void 0!==a?a:null,this.tenantId=null!==(o=s.tenantId)&&void 0!==o?o:null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
