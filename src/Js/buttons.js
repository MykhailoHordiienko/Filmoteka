            ...
            init(){
                try{
                    ...
                    if (!this.saveFilm1) { 
                        ...
                        inWatched(){createlibraryGallery(this.massivout(this.LOCAL_STORAGE_KEY)); this.changeOnLocMasW()},
                        inQueue(){createlibraryGallery(this.massivout(this.LOCAL_STORAGE_KEY_QUEUE)); this.changeOnLocMasq()},
